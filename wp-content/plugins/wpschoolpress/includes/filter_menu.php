...
$sch_teacher = apply_filters('wpsp_sidebar_teacher_title_menu',_t( 'Teachers' ) );
$sch_student = apply_filters('wpsp_sidebar_student_title_menu',_t( 'Students' ) );
...
$sch_student_attendance = apply_filters('wpsp_sidebar_student_attendance_title_menu', _t( 'Students Attendance' ));
$sch_teacher_attendance = apply_filters('wpsp_sidebar_teacher_attendance_title_menu',_t( 'Teachers Attendance' ) );
