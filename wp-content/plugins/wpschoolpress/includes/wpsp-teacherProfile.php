    ...
    <div class="wpsp-col-xs-12">
      <div class="wpsp-card">
        <div class="wpsp-card-head">
          ...
          <?php
    /*
          <h5 class="wpsp-card-subtitle">
            <?php echo $tinfo->first_name.' '.$tinfo->middle_name.' '.$tinfo->last_name;?>
          </h5> */
?>
        </div>
...
?>
                  <img class="wpsp-upAvatar" id="img_preview_teacher" src="
                    <?php
    echo $img_url;
?>">
...
?>
                      ...
                      <?php
    wp_nonce_field('TeacherRegister', 'tregister_nonce', '', true);
?>
                      <div class="clearfix wpsp-ipad-show"></div>
                      <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                        <div class="wpsp-form-group">
                          <label class="wpsp-label" for="firstname">First Name 
...
?>
    ...
    if ($edit) {
?>
                                  <input type="text" class="wpsp-form-control select_date datepicker" value="<?php
                                        if ($tinfo->dob == "0000-00-00") {
                                            } else {
...
?>
                                ...
                                <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                                  <div class="wpsp-form-group">
                                    <label class="wpsp-label" for="Email">Email Address
                                      <span class="wpsp-required"> *</span>
                                    </label>
                                    <?php
    if ($edit) {
...
?>
                                            <option value="<?php echo $value;?>" 
                                              <?php
            echo selected($tinfo->country, $value);
?>>
                                              <?php
            echo $value;
?>
...
?>
                                      ...
                                      <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                                        <div class="wpsp-form-group">
                                          <label class="wpsp-label" for="Zip Code">Pin Code
                                            <span class="wpsp-required"> *
                                            </label>
                                          </label>
                                          <?php
...
?>
                                              ...
                                              <?php
        echo wpsp_admin_url();
?>sch-teacher' class="wpsp-btn wpsp-dark-btn">Back</a> -->
                                              <?php
    } else {
?>
                                              <a href="?id=
                                                <?php
        echo $tinfo->wp_usr_id;
?>&edit=true" type="button" class="wpsp-btn wpsp-btn-sm wpsp-btn-warning">
                                                <i class="icon dashicons dashicons-edit wpsp-edit-icon"></i>
                                              </a>
                                              <a data-original-title="Remove this user" type="button" class="wpsp-btn wpsp-btn-sm wpsp-btn-danger">
                                                <i class="icon dashicons dashicons-trash wpsp-delete-icon"></i>
                                              </a>
                                              <?php
    }
?>
    ...
    if ($edit) {
?>
                                                <input type="text" class="wpsp-form-control select_date" value="<?php
        if (wpsp_viewDate($tinfo->doj) == "0000-00-00") {
        } else {
            echo wpsp_viewDate($tinfo->doj);
        }
?>" id="Doj" name="Doj" placeholder="Date of Join">
                                                  <?php
    } else
        echo wpsp_viewDate($tinfo->doj);
?>
...
?>
                                                  <input type="text" class="wpsp-form-control select_date" value="<?php
        if (wpsp_viewDate($tinfo->dol) == "0000-00-00") {
        } else {
            echo wpsp_viewDate($tinfo->dol);
        }
?>" id="Dol" name="dol" placeholder="Date of Leave">
                                                    <?php
    } else
        echo wpsp_viewDate($tinfo->dol);
?>
...
?>
    ...
    if ($edit) {
?>
                                                      <input type="text" class="wpsp-form-control" id="Position" name="Position" value="<?php
        echo $tinfo->position;
...
?>
                                                      ...
                                                      <div class="wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
                                                    <div class="wpsp-form-group">
                                                      <label class="wpsp-label" for="Position">Designation </label>
                                                      <?php if ($edit) { ?>
                    											...
                    											<option value="">Select Designation</option>
                    												<?php 
                    		                                              foreach( ( new CDesignations )->arrstrDesignations as $intDesignationId => $strDesigntion ) {
                    		                                                  echo '<option value="' . $intDesignationId . '" ' . ( ( $tinfo->designation_id == $intDesignationId ) ? "selected='selected'" : "" ) . ' >' . $strDesigntion . '</option>';
                    		                                              }
                    		                                        ?>
                    										</select>                                                     
                                                        <?php
    } else
        echo $tinfo->designation_id;
?>
                                                      </div>
                                                    </div>
                                                    <div class="wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
...
?>
                                                        ...
                                                        <a href='
                                                          <?php
        echo wpsp_admin_url();
?>sch-teacher' class="wpsp-btn wpsp-dark-btn">Back
                                                        </a>
                                                        <?php
    } else {
?>
                                                        <a href="?id=
                                                          <?php
        echo $tinfo->wp_usr_id;
?>&edit=true" type="button" class="btn btn-sm btn-warning">
