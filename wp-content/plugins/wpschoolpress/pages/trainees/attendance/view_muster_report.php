...
<div class="ritz grid-container" dir="ltr" id="attendance-mustur-report">
   <table id="printMuster" class="waffle" cellspacing="0" cellpadding="0">
      <tbody>
         ...
         <tr style='height:19px;'>
            <td class="s1 border-left" colspan="5">Instrctor Name </td>
            <td class="s1">:-</td>
            <td class="s1" colspan="3"><?php echo $teacher->first_name . ' ' . $teacher->middle_name . ' '. $teacher->last_name; ?></td>
            <td class="s1" colspan="8">Sub Instructor Name </td>
            <td class="s1">:-</td>
            <td class="s1" colspan="9"><?php echo $teacher->first_name . ' ' . $teacher->middle_name . ' '. $teacher->last_name; ?></td>
            <td class="s1" colspan="4">Profession -</td>
            <td class="s2" colspan="6"><?php echo $unit->unit_name; ?> Instructor </td>
            <td class="s1"></td>
            <td class="s1" colspan="2"></td>
            <td class="s1" colspan="2"><?php $batch->name?></td>
            <td class="s1" colspan="2">Devision -</td>
            <td class="s1" colspan="3"><?php echo $unit->unit_name; ?></td>
         </tr>
         <tr style='height:19px;'>
            <td class="s3 border-left" colspan="6">Last Month Details</td>
            <td class="s4 padding10" rowspan="2">%</td>
            <td class="s4 padding10" rowspan="2">No.</td>
            <td class="s4 padding10" rowspan="2">Trainee Name </td>
            <td class="s4 " colspan="31">Month: <?php echo ( new DateTime )->createFromFormat('!m', $month )->format( 'F' ); ?> <?php echo $year; ?></td>
            <td class="s4" colspan="7">Current Month Details </td>
         </tr>
         <tr style='height:58px;'>
            <td class="s5 softmerge border-left">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;text-align:center;">W Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;text-align:center">P Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;text-align:center">A Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;text-align:center">CL Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;text-align:center">SL Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;text-align:center">SPL Day</div>
            </td>
            ...
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;"><span style=" width:30px; transform: rotate(-90deg);">W Day </span></div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;">P Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;">A Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 20px; left: -1px;">CL Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;">SL Day</div>
            </td>
            <td class="s5 softmerge">
               <div class="softmerge-inner textRotate" style="width: 19px; left: -1px;">SPL Day</div>
            </td>
         ...
         <tr style='height:16px;'>
            ...
            <td class="s5"><?php echo ( 0!= $lptas[$student->sid]->present_count ) ? ceil( $lptas[$student->sid]->present_count / $lptas[$student->sid]->total_working_day_count * 100 ) : 0; ?></td>
            <td class="s6"><?php echo $student->s_rollno; ?></td>
         ...
         <tr style='height:16px;'>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Present </td>
            

            <?php for( $i=1; $i<=date('t', mktime(0, 0, 0, $month, 1, $year ) ); $i++ ) {
                $intDaysInMonth=$i;
                echo '<td class="s5">' . ( isset( $daily_trainee_attendance_stats[$i] ) ? $daily_trainee_attendance_stats[$i]->daily_present_count : 0 ). '</td>';
            }
            $intDaysInMonth++;
            while( $intDaysInMonth <= 31 ) {
                echo '<td class="s5"></td>';
            ...
            <td class="s5" colspan="5" >Total Present</td>
         ...
         <tr style='height:16px;'>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Casual Leave</td>
            <?php for( $i=1; $i<=date('t', mktime(0, 0, 0, $month, 1, $year ) ); $i++ ) {
                $intDaysInMonth=$i;
                echo '<td class="s5">' . ( isset( $daily_trainee_attendance_stats[$i] ) ? $daily_trainee_attendance_stats[$i]->daily_cl_count : 0 ). '</td>';
            }
            ...
            ?>
            <td class="s5" colspan="5" >Total Absent </td>
         ...
         <tr style='height:16px;'>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Sick Leave</td>
            <?php for( $i=1; $i<=date('t', mktime(0, 0, 0, $month, 1, $year ) ); $i++ ) {
                $intDaysInMonth=$i;
                echo '<td class="s5">' . ( isset( $daily_trainee_attendance_stats[$i] ) ? $daily_trainee_attendance_stats[$i]->daily_sl_count : 0 ). '</td>';
            }
            $intDaysInMonth++;
            while( $intDaysInMonth <= 31 ) {
                echo '<td class="s5" ></td>';
            ...
            ?>
            <td class="s5" colspan="5">Casual Leave </td>
         ...
         <tr style='height:16px;'>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Special Leave</td>
            <?php for( $i=1; $i<=date('t', mktime(0, 0, 0, $month, 1, $year ) ); $i++ ) {
                $intDaysInMonth=$i;
                echo '<td class="s5">' . ( isset( $daily_trainee_attendance_stats[$i] ) ? $daily_trainee_attendance_stats[$i]->daily_spl_count : 0 ). '</td>';
            }
            ...
            ?>
            <td class="s5" colspan="5">Sick Leave</td>
         ...
         <tr style='height:16px;'>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Absent</td>
            <?php for( $i=1; $i<=date('t', mktime(0, 0, 0, $month, 1, $year ) ); $i++ ) {
                $intDaysInMonth=$i;
                echo '<td class="s5">' . ( isset( $daily_trainee_attendance_stats[$i] ) ? $daily_trainee_attendance_stats[$i]->daily_absent_count : 0 ) . '</td>';
            }
            $intDaysInMonth++;
            while( $intDaysInMonth <= 31 ) {
                echo '<td class="s5" ></td>';
            ...
            ?>
            <td class="s5" colspan="5">Special Leave</td>
         ...
         <tr style='height:16px;'>
            ...
            for( $i=1; $i<= date('t', mktime(0, 0, 0, $month, 1, $year ) ); $i++) {
                    ...
                    echo '<td class="s5">' . ( $daily_absent_count + $daily_spl_count + $daily_sl_count + $daily_cl_count + $daily_present_count ) . '</td>';
         ...
         <tr style='height:16px;'>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Instructor Sign</td>
            <td class="s5"></td>
            <td class="s5"></td>
            <td class="s5"></td>
            <td class="s5"></td>
            ...
            <td class="s5"></td>
            <td class="s5"></td>
            <td class="s5" colspan="5">Instructor Sign</td>
            <td class="s4" colspan="2"></td>
         </tr>
         <tr style='height:16px;'>
            <td class="s7"></td>
            ...
            <td class="s7"></td>
            <td class="s8"></td>
            <td class="s5">Sub Instructor Sign </td>
            <td class="s5"></td>
            <td class="s5"></td>
            <td class="s5"></td>
            <td class="s5"></td>
            ...
            <td class="s5"></td>
            <td class="s5"></td>
            <td class="s5" colspan="5">Sub Instructor Sign </td>
            <td class="s4" colspan="2"></td>
         </tr>
      </tbody>
   </table>
