...
function wpsp_admin_menu() {
	...
	if($current_user_role=='administrator' || $current_user_role=='teacher'){
		...
		add_submenu_page('ITIMS', 'ITIMS',  '<i class="fa fa-key fa-fw"></i>&nbsp; Sell', 'edit_posts', CModules::SELL['slug'], array(
		    $this,
		    'wpsp_callback'
		));	
		
		add_submenu_page('ITIMS', 'ITIMS',  '<i class="fa fa-key fa-fw"></i>&nbsp; Scrip', 'edit_posts', CModules::SCRIPT['slug'], array(
		    $this,
		    'wpsp_callback'
		));	
