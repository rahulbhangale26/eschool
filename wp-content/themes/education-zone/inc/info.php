...
function education_zone_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'education-zone' ) . ': </label><a href="' . esc_url( 'https://demo.rarathemes.com/education-zone/' ) . '" target="_blank">' . __( 'Click here', 'education-zone' ) . '</a></span><br />';
