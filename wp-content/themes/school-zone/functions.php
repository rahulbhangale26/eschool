...
function school_zone_customize_register( $wp_customize ){
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'school-zone' ) . ': </label><a href="' . esc_url( 'https://demo.rarathemes.com/school-zone/' ) . '" target="_blank">' . __( 'Click here', 'school-zone' ) . '</a></span><br />';
